...
type IShowR interface {
	...
	Find(ctx context.Context, show search.Show, sort search.Sort) ([]models.Show, error)
...
type IPersonR interface {
	...
	Find(ctx context.Context, person search.Person, sort search.Sort) ([]models.Person, error)
